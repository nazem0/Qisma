...
export function apiDashboardPropertyImagesAddPost$Json(http: HttpClient, rootUrl: string, params?: ApiDashboardPropertyImagesAddPost$Json$Params, context?: HttpContext): Observable<StrictHttpResponse<StringApiResult>> {
