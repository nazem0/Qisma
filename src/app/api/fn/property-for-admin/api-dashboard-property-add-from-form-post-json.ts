...
export function apiDashboardPropertyAddFromFormPost$Json(http: HttpClient, rootUrl: string, params?: ApiDashboardPropertyAddFromFormPost$Json$Params, context?: HttpContext): Observable<StrictHttpResponse<StringApiResult>> {
  const rb = new RequestBuilder(rootUrl, apiDashboardPropertyAddFromFormPost$Json.PATH, 'post');
  if (params) {
...
apiDashboardPropertyAddFromFormPost$Json.PATH = '/api/Dashboard/Property/AddFromForm';
