...
export function apiDashboardPropertyAddFromFormPost$Json(http: HttpClient, rootUrl: string, params?: ApiDashboardPropertyAddFromFormPost$Json$Params, context?: HttpContext): Observable<StrictHttpResponse<Int32ApiResult>> {
